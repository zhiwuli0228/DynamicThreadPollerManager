...
Configure JUnit 5 parallel test execution to reduce total test suite runtime by running test classes concurrently across available CPU cores, while preserving sequential execution within individual classes and isolating Spring Boot context tests.

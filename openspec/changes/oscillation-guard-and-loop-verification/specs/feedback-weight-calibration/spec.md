...
The system SHALL provide package-visible weight getters on ThresholdPolicyScorer for FeedbackCalibrator access.
...
#### Scenario: Getters are package-visible
- **GIVEN** a class in experiment.classification package
